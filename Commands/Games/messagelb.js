...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        const Fetching = new Discord.MessageEmbed()
            .setColor('#a8f1ff')
            .setDescription(`**Fetching the past ${L} messages**`)
        ...
        async function fetchMore(channel, limit = 5000) {
            ...
            while (remaining > 0) {
                ...
                Array.from(cmessages.values()).forEach(m => messages.push(message.author.id))
                if (!cmessages.last()) {
                    break;
                }
...

        {
            try {
                ...
                const embed = new Discord.MessageEmbed()
                    ...
                    .setColor('#a8f1ff')
                    .setDescription(`🔹│**${Object.keys(finalthingyig)[0]}** - \`${Object.values(finalthingyig)[0]}\`
